  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Detalle Venta en Verde PD - Desde  ${starttime} Hasta ${starttime}  <span class="divider"></span></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Detalle Venta en Verde PD - Con OD </h3>
				<!-- 
              <div class="box-tools">
					  	...
					  	<div class="row">
							<div class="col-sm-12 col-xs-12">
							  <div class="description-block">
								<span class="description-percentage  text-green" style="font-size:40px"><i class="fa fa-caret-right"></i> 
								<c:choose>
								...
								<span class="description-text" style="font-size:20px">Cantidad Con OD</span>
							  </div>
							  <!-- /.description-block -->
							</div>
					  	</div>
