  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Reporte Cuadratura Venta en Verde PD - Fecha Desde  ${starttime} Hasta ${starttime}<span class="divider"></span></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Detalle Venta En Verde PD- Sin OD</h3>
				<!-- 
              <div class="box-tools">
					  	...
					  	<div class="row">
							<div class="col-sm-12 col-xs-12">
							  <div class="description-block">
								<span class="description-percentage  text-red" style="font-size:40px"><i class="fa fa-caret-right"></i> 
								<c:choose>
								...
								<span class="description-text" style="font-size:20px">Cantidad Sin OD</span>
							  </div>
							  <!-- /.description-block -->
							</div>
					  	</div>
								...
								<td>
									    <c:choose>
											...
											<c:when test="${empty detalle.nOrdenDistribu}">
												...
												<i class="fa fa-times" aria-hidden="true"></i> No encontrado
												</span>
											</c:when>
											<c:otherwise>
												<span class="label label-success">
												<i class="fa fa-check-circle" aria-hidden="true"></i>  ${detalle.nOrdenDistribu}</span>
											</c:otherwise>
										</c:choose>
								</td>
								<td>
								<c:choose>
											<c:when test="${empty detalle.fechaCreacionOrden}">
												<span class="label label-danger"  style=" background-color:#d9534f">
												<i class="fa fa-times" aria-hidden="true"></i> No encontrado
												</span>
											</c:when>
											<c:otherwise>
												<span class="label label-success">
												<i class="fa fa-check-circle" aria-hidden="true"></i> ${detalle.fechaCreacionOrden}
												</span>
											</c:otherwise>
										</c:choose>
		...
		<div class="col-sm-12 col-xs-12">
			<div class="description-block">
				<h5 class="description-header" style="font-size:30px">
					<form role="form" id="f_all_user" method="get" action="reportODVentaVerde">
						<input type="text" value="${dateInicio}"  name="dateInicio" id="dateInicio" class="form-control span12" style="width:170px;" />
