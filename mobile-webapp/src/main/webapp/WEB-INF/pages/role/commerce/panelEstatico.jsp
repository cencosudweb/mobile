									          ...
									          <div class="modal-dialog">
												...
												try{
													...
													SQLCumple = "	SELECT  " +
																...
																"	WHERE  1 = 1  " + 
																"   AND TC.ID_CUMPLE = 1 "  +
																" 	AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' " +
														...
														<script type="text/javascript">
															...
															$(function(){
																$("#ocultar_cumplimiento_<%=contarCumple%>").click(function() {
																	<%
														        	SQLHideCumplimiento = "SELECT  TC.ID_CUMPLE_RESUMEN from cumplimiento_kpiweb TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple.getInt("ID_CUMPLE")+" GROUP BY TC.ID_CUMPLE_RESUMEN ORDER BY TC.ID_CUMPLE_RESUMEN ASC";
								                                    ...
								                                    %>
																		...
																		<%
																		SQLHideCumpleResumen = "SELECT  TC.ID_CUMPLIMIENTO_2 from cumplimiento_kpiweb TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple.getInt("ID_CUMPLE")+" AND TC.ID_CUMPLE_RESUMEN = "+rsHideCumplimiento.getInt("ID_CUMPLE_RESUMEN")+" GROUP BY TC.ID_CUMPLIMIENTO_2 ORDER BY TC.ID_CUMPLIMIENTO_2 ASC";
																		...
																		%>
																			...
																			<%
																			SQLHideResponsable = "SELECT  TC.ID_RESPONSABLE from cumplimiento_kpiweb TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple.getInt("ID_CUMPLE")+" AND TC.ID_CUMPLE_RESUMEN = "+rsHideCumplimiento.getInt("ID_CUMPLE_RESUMEN")+" AND TC.ID_CUMPLIMIENTO_2 = "+rsHideCumpleResumen.getInt("ID_CUMPLIMIENTO_2")+" GROUP BY TC.ID_RESPONSABLE ORDER BY TC.ID_RESPONSABLE ASC";
																...
																$("#mostrar_cumplimiento_<%=contarCumple%>").click(function() {
																	<%
														        	SQLShowCumplimiento = "SELECT  TC.ID_CUMPLE_RESUMEN from cumplimiento_kpiweb TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple.getInt("ID_CUMPLE")+" GROUP BY TC.ID_CUMPLE_RESUMEN ORDER BY TC.ID_CUMPLE_RESUMEN ASC";
								                                    ...
								                                    %>
																		...
																		<%
																		SQLShowCumpleResumen = "SELECT  TC.ID_CUMPLIMIENTO_2 from cumplimiento_kpiweb TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple.getInt("ID_CUMPLE")+" AND TC.ID_CUMPLE_RESUMEN = "+rsShowCumplimiento.getInt("ID_CUMPLE_RESUMEN")+"  GROUP BY TC.ID_CUMPLIMIENTO_2 ORDER BY TC.ID_CUMPLIMIENTO_2 ASC";
															...
															<script type="text/javascript">
																$(function(){
																	$("#ocultar_cumple_resumen_<%=contarCumple%>_<%=contarCumplimiento%>").click(function() {
																		<%
																		SQLHideCumpleResumen = "SELECT  TC.ID_CUMPLIMIENTO_2 from cumplimiento_kpiweb TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple.getInt("ID_CUMPLE")+" AND TC.ID_CUMPLE_RESUMEN = "+rsCumplimiento.getInt("ID_CUMPLE_RESUMEN")+" GROUP BY TC.ID_CUMPLIMIENTO_2 ORDER BY TC.ID_CUMPLIMIENTO_2 ASC";
																		psHideCumpleResumen = conn.prepareStatement(SQLHideCumpleResumen, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
																		rsHideCumpleResumen = psHideCumpleResumen.executeQuery();
																		conn.commit();
																		int contarHideCumpleResumen = 0;
																		...
																		%>
																			...
																			<%
																			SQLHideResponsable = "SELECT  TC.ID_RESPONSABLE from cumplimiento_kpiweb TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple.getInt("ID_CUMPLE")+"  AND TC.ID_CUMPLE_RESUMEN = "+rsCumplimiento.getInt("ID_CUMPLE_RESUMEN")+" AND TC.ID_CUMPLIMIENTO_2 = "+rsHideCumpleResumen.getInt("ID_CUMPLIMIENTO_2")+" GROUP BY TC.ID_RESPONSABLE ORDER BY TC.ID_RESPONSABLE ASC";
																			psHideResponsable = conn.prepareStatement(SQLHideResponsable, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
																			rsHideResponsable = psHideResponsable.executeQuery();
																			conn.commit();
																			int contarHideResponsable = 0;
																	...
																	$("#mostrar_cumple_resumen_<%=contarCumple%>_<%=contarCumplimiento%>").click(function() {
																		<%
																		SQLShowCumpleResumen = "SELECT  TC.ID_CUMPLIMIENTO_2 from cumplimiento_kpiweb TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple.getInt("ID_CUMPLE")+" AND TC.ID_CUMPLE_RESUMEN = "+rsCumplimiento.getInt("ID_CUMPLE_RESUMEN")+" GROUP BY TC.ID_CUMPLIMIENTO_2 ORDER BY TC.ID_CUMPLIMIENTO_2 ASC";
																		psShowCumpleResumen = conn.prepareStatement(SQLShowCumpleResumen, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
																		rsShowCumpleResumen = psShowCumpleResumen.executeQuery();
																		conn.commit();
																		int contarShowCumpleResumen = 0;
																...
																<script type="text/javascript">
																	$(function(){
																		...
																		$("#mostrar_responsable_<%=contarCumple%>_<%=contarCumplimiento%>_<%=contarCumpleResumen%>").click(function() {
																			<%
																			SQLShowResponsable = "SELECT  TC.ID_RESPONSABLE from cumplimiento_kpiweb TC WHERE  1 = 1  AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple.getInt("ID_CUMPLE")+" AND TC.ID_CUMPLE_RESUMEN = "+rsCumplimiento.getInt("ID_CUMPLE_RESUMEN")+" AND TC.ID_CUMPLIMIENTO_2 = "+rsCumpleResumen.getInt("ID_CUMPLIMIENTO_2")+"  GROUP BY TC.ID_RESPONSABLE ORDER BY TC.ID_RESPONSABLE ASC";
														...
														<script type="text/javascript">
															...
															$(function(){
																$("#ocultar_cumplimiento2_<%=contarCumple2%>").click(function() {
																	<%
														        	SQLHideCumplimiento2 = "SELECT  TC.ID_CUMPLE_RESUMEN from cumplimiento_kpiweb TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple2.getInt("ID_CUMPLE")+" GROUP BY TC.ID_CUMPLE_RESUMEN ORDER BY TC.ID_CUMPLE_RESUMEN ASC";
								                                    ...
								                                    %>
																		...
																		<%
																		SQLHideCumpleResumen2 = "SELECT  TC.ID_CUMPLIMIENTO_2 from cumplimiento_kpiweb TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple2.getInt("ID_CUMPLE")+" AND TC.ID_CUMPLE_RESUMEN = "+rsHideCumplimiento2.getInt("ID_CUMPLE_RESUMEN")+" GROUP BY TC.ID_CUMPLIMIENTO_2 ORDER BY TC.ID_CUMPLIMIENTO_2 ASC";
																		...
																		%>
																			...
																			<%
																			SQLHideResponsable2 = "SELECT  TC.ID_RESPONSABLE from cumplimiento_kpiweb TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple2.getInt("ID_CUMPLE")+" AND TC.ID_CUMPLE_RESUMEN = "+rsHideCumplimiento2.getInt("ID_CUMPLE_RESUMEN")+" AND TC.ID_CUMPLIMIENTO_2 = "+rsHideCumpleResumen2.getInt("ID_CUMPLIMIENTO_2")+" GROUP BY TC.ID_RESPONSABLE ORDER BY TC.ID_RESPONSABLE ASC";
																...
																$("#mostrar_cumplimiento2_<%=contarCumple2%>").click(function() {
																	<%
														        	SQLShowCumplimiento2 = "SELECT  TC.ID_CUMPLE_RESUMEN from cumplimiento_kpiweb TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple2.getInt("ID_CUMPLE")+" GROUP BY TC.ID_CUMPLE_RESUMEN ORDER BY TC.ID_CUMPLE_RESUMEN ASC";
								                                    ...
								                                    %>
																		...
																		<%
																		SQLShowCumpleResumen2 = "SELECT  TC.ID_CUMPLIMIENTO_2 from cumplimiento_kpiweb TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple2.getInt("ID_CUMPLE")+" AND TC.ID_CUMPLE_RESUMEN = "+rsShowCumplimiento2.getInt("ID_CUMPLE_RESUMEN")+"  GROUP BY TC.ID_CUMPLIMIENTO_2 ORDER BY TC.ID_CUMPLIMIENTO_2 ASC";
															...
															<script type="text/javascript">
																$(function(){
																	$("#ocultar_cumple_resumen2_<%=contarCumple2%>_<%=contarCumplimiento2%>").click(function() {
																		<%
																		SQLHideCumpleResumen2 = "SELECT  TC.ID_CUMPLIMIENTO_2 from cumplimiento_kpiweb TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple2.getInt("ID_CUMPLE")+" AND TC.ID_CUMPLE_RESUMEN = "+rsCumplimiento2.getInt("ID_CUMPLE_RESUMEN")+" GROUP BY TC.ID_CUMPLIMIENTO_2 ORDER BY TC.ID_CUMPLIMIENTO_2 ASC";
																		psHideCumpleResumen2 = conn2.prepareStatement(SQLHideCumpleResumen2, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
																		rsHideCumpleResumen2 = psHideCumpleResumen2.executeQuery();
																		conn2.commit();
																		int contarHideCumpleResumen2 = 0;
																		...
																		%>
																			...
																			<%
																			SQLHideResponsable2 = "SELECT  TC.ID_RESPONSABLE from cumplimiento_kpiweb TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple2.getInt("ID_CUMPLE")+"  AND TC.ID_CUMPLE_RESUMEN = "+rsCumplimiento2.getInt("ID_CUMPLE_RESUMEN")+" AND TC.ID_CUMPLIMIENTO_2 = "+rsHideCumpleResumen2.getInt("ID_CUMPLIMIENTO_2")+" GROUP BY TC.ID_RESPONSABLE ORDER BY TC.ID_RESPONSABLE ASC";
																			psHideResponsable2 = conn2.prepareStatement(SQLHideResponsable2, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
																			rsHideResponsable2 = psHideResponsable2.executeQuery();
																			conn2.commit();
																			int contarHideResponsable2 = 0;
																	...
																	$("#mostrar_cumple_resumen2_<%=contarCumple2%>_<%=contarCumplimiento2%>").click(function() {
																		<%
																		SQLShowCumpleResumen2 = "SELECT  TC.ID_CUMPLIMIENTO_2 from cumplimiento_kpiweb TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple2.getInt("ID_CUMPLE")+" AND TC.ID_CUMPLE_RESUMEN = "+rsCumplimiento2.getInt("ID_CUMPLE_RESUMEN")+" GROUP BY TC.ID_CUMPLIMIENTO_2 ORDER BY TC.ID_CUMPLIMIENTO_2 ASC";
																		psShowCumpleResumen2 = conn2.prepareStatement(SQLShowCumpleResumen2, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
																		rsShowCumpleResumen2 = psShowCumpleResumen2.executeQuery();
																		conn2.commit();
																		int contarShowCumpleResumen2 = 0;
																...
																<script type="text/javascript">
																	$(function(){
																		...
																		$("#mostrar_responsable2_<%=contarCumple2%>_<%=contarCumplimiento2%>_<%=contarCumpleResumen2%>").click(function() {
																			<%
																			SQLShowResponsable2 = "SELECT  TC.ID_RESPONSABLE from cumplimiento_kpiweb TC WHERE  1 = 1  AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple2.getInt("ID_CUMPLE")+" AND TC.ID_CUMPLE_RESUMEN = "+rsCumplimiento2.getInt("ID_CUMPLE_RESUMEN")+" AND TC.ID_CUMPLIMIENTO_2 = "+rsCumpleResumen2.getInt("ID_CUMPLIMIENTO_2")+"  GROUP BY TC.ID_RESPONSABLE ORDER BY TC.ID_RESPONSABLE ASC";
														...
														<script type="text/javascript">
															...
															$(function(){
																$("#ocultar_cumplimiento3_<%=contarCumple3%>").click(function() {
																	<%
														        	SQLHideCumplimiento3 = "SELECT  TC.ID_CUMPLE_RESUMEN from cumplimiento_kpiweb TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple3.getInt("ID_CUMPLE")+" GROUP BY TC.ID_CUMPLE_RESUMEN ORDER BY TC.ID_CUMPLE_RESUMEN ASC";
								                                    ...
								                                    %>
																		...
																		<%
																		SQLHideCumpleResumen3 = "SELECT  TC.ID_CUMPLIMIENTO_2 from cumplimiento_kpiweb TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple3.getInt("ID_CUMPLE")+" AND TC.ID_CUMPLE_RESUMEN = "+rsHideCumplimiento3.getInt("ID_CUMPLE_RESUMEN")+" GROUP BY TC.ID_CUMPLIMIENTO_2 ORDER BY TC.ID_CUMPLIMIENTO_2 ASC";
																		...
																		%>
																			...
																			<%
																			SQLHideResponsable3 = "SELECT  TC.ID_RESPONSABLE from cumplimiento_kpiweb TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple3.getInt("ID_CUMPLE")+" AND TC.ID_CUMPLE_RESUMEN = "+rsHideCumplimiento3.getInt("ID_CUMPLE_RESUMEN")+" AND TC.ID_CUMPLIMIENTO_2 = "+rsHideCumpleResumen3.getInt("ID_CUMPLIMIENTO_2")+" GROUP BY TC.ID_RESPONSABLE ORDER BY TC.ID_RESPONSABLE ASC";
																...
																$("#mostrar_cumplimiento3_<%=contarCumple3%>").click(function() {
																	<%
														        	SQLShowCumplimiento3 = "SELECT  TC.ID_CUMPLE_RESUMEN from cumplimiento_kpiweb TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple3.getInt("ID_CUMPLE")+" GROUP BY TC.ID_CUMPLE_RESUMEN ORDER BY TC.ID_CUMPLE_RESUMEN ASC";
								                                    ...
								                                    %>
																		...
																		<%
																		SQLShowCumpleResumen3 = "SELECT  TC.ID_CUMPLIMIENTO_2 from cumplimiento_kpiweb TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple3.getInt("ID_CUMPLE")+" AND TC.ID_CUMPLE_RESUMEN = "+rsShowCumplimiento3.getInt("ID_CUMPLE_RESUMEN")+"  GROUP BY TC.ID_CUMPLIMIENTO_2 ORDER BY TC.ID_CUMPLIMIENTO_2 ASC";
															...
															<script type="text/javascript">
																$(function(){
																	$("#ocultar_cumple_resumen3_<%=contarCumple3%>_<%=contarCumplimiento3%>").click(function() {
																		<%
																		SQLHideCumpleResumen3 = "SELECT  TC.ID_CUMPLIMIENTO_2 from cumplimiento_kpiweb TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple3.getInt("ID_CUMPLE")+" AND TC.ID_CUMPLE_RESUMEN = "+rsCumplimiento3.getInt("ID_CUMPLE_RESUMEN")+" GROUP BY TC.ID_CUMPLIMIENTO_2 ORDER BY TC.ID_CUMPLIMIENTO_2 ASC";
																		psHideCumpleResumen3 = conn3.prepareStatement(SQLHideCumpleResumen3, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
																		rsHideCumpleResumen3 = psHideCumpleResumen3.executeQuery();
																		conn3.commit();
																		int contarHideCumpleResumen3 = 0;
																		...
																		%>
																			...
																			<%
																			SQLHideResponsable3 = "SELECT  TC.ID_RESPONSABLE from cumplimiento_kpiweb TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple3.getInt("ID_CUMPLE")+"  AND TC.ID_CUMPLE_RESUMEN = "+rsCumplimiento3.getInt("ID_CUMPLE_RESUMEN")+" AND TC.ID_CUMPLIMIENTO_2 = "+rsHideCumpleResumen3.getInt("ID_CUMPLIMIENTO_2")+" GROUP BY TC.ID_RESPONSABLE ORDER BY TC.ID_RESPONSABLE ASC";
																			psHideResponsable3 = conn3.prepareStatement(SQLHideResponsable3, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
																			rsHideResponsable3 = psHideResponsable3.executeQuery();
																			conn3.commit();
																			int contarHideResponsable3 = 0;
																	...
																	$("#mostrar_cumple_resumen3_<%=contarCumple3%>_<%=contarCumplimiento3%>").click(function() {
																		<%
																		SQLShowCumpleResumen3 = "SELECT  TC.ID_CUMPLIMIENTO_2 from cumplimiento_kpiweb TC WHERE  1 = 1 AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple3.getInt("ID_CUMPLE")+" AND TC.ID_CUMPLE_RESUMEN = "+rsCumplimiento3.getInt("ID_CUMPLE_RESUMEN")+" GROUP BY TC.ID_CUMPLIMIENTO_2 ORDER BY TC.ID_CUMPLIMIENTO_2 ASC";
																		psShowCumpleResumen3 = conn3.prepareStatement(SQLShowCumpleResumen3, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
																		rsShowCumpleResumen3 = psShowCumpleResumen3.executeQuery();
																		conn3.commit();
																		int contarShowCumpleResumen3 = 0;
																...
																<script type="text/javascript">
																	$(function(){
																		...
																		$("#mostrar_responsable3_<%=contarCumple3%>_<%=contarCumplimiento3%>_<%=contarCumpleResumen3%>").click(function() {
																			<%
																			SQLShowResponsable3 = "SELECT  TC.ID_RESPONSABLE from cumplimiento_kpiweb TC WHERE  1 = 1  AND TC.FECHA_COMPROMISO_EOM >= '"+starttime+"' AND TC.FECHA_COMPROMISO_EOM <= '"+starttime+"' AND TC.ID_CUMPLE = "+rsCumple3.getInt("ID_CUMPLE")+" AND TC.ID_CUMPLE_RESUMEN = "+rsCumplimiento3.getInt("ID_CUMPLE_RESUMEN")+" AND TC.ID_CUMPLIMIENTO_2 = "+rsCumpleResumen3.getInt("ID_CUMPLIMIENTO_2")+"  GROUP BY TC.ID_RESPONSABLE ORDER BY TC.ID_RESPONSABLE ASC";
