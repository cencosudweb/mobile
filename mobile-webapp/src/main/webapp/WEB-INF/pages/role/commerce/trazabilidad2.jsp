	  		...
	  		<div class="row">
				...
				<div class="col-md-12">
				  ...
				  <div class="box box-primary">
					...
					<form class="form-inline"  method="get" action="trazabilidad">
					<!--	
			...
			<!-- /.row -->
			  ...
			  <div class="row">
				<div class="col-md-12">
				  <div class="box">
					<div class="box-header with-border">
					  <h3 class="box-title">Trazabilidad Orden con Despacho</h3>
						...
						<div class="row">
							<div class="col-sm-12 col-xs-12">
							  <div class="description-block">
							  	<a href="soporteVentaDetalle?dateInicio=<%=starttime%>&estado=0" alt="Soporte Venta Detalle" title="Soporte Venta Detalle">
								...
								<a href="soporteVentaDetalle?dateInicio=<%=starttime%>&estado=0" style="color: #333">
								<c:choose>
								  <c:when test="${cantSoporte > 0}">
								    <fmt:formatNumber pattern="#,###,#00" value="${cantSoporte}"  type="number"/>
								  </c:when>
								  <c:otherwise>
								    0
								  </c:otherwise>
								...
								<span class="description-text" style="font-size:20px">SOPORTE VENTA</span>
							  </div>
							  <!-- /.description-block -->
							</div>
					  	</div>
					  	...
					  	<div class="row">
							<div class="col-sm-12 col-xs-12">
							  <div class="description-block">
							  	<a href="eom?dateInicio=<%=starttime%>&estado=0" alt="Eom Detalle" title="Eom Detalle">
								<span class="description-percentage text-yellow"><i class="fa fa-caret-right"></i> 
								</span>
								</a>
								<h5 class="description-header" style="font-size:40px">
								<a href="eom?dateInicio=<%=starttime%>&estado=0" style="color: #333">
								<c:choose>
								  <c:when test="${cantSoporteVentaEomFind > 0}">
								    <fmt:formatNumber pattern="#,###,#00" value="${cantSoporteVentaEomFind}"  type="number"/>
								  </c:when>
								  <c:otherwise>
								    0
								  </c:otherwise>
								...
								<span class="description-text" style="font-size:20px">EOM</span>
							  </div>
							  <!-- /.description-block -->
							</div>
					  	</div>
					  	...
					  	<div class="row">
							<div class="col-sm-16 col-xs-6">
							  <div class="description-block border-right">
							  	<a href="detalleNoEncontradoWms?dateInicio=<%=starttime%>&estado=0" >
								<span class="description-percentage text-yellow"><i class="fa fa-caret-right"></i>
								<!--  
								-
								<c:choose>
								  <c:when test="${cantSoporteVentaWmsDif > 0}">
								    <fmt:formatNumber pattern="#,###,#00" value="${cantSoporteVentaWmsDif}"  type="number"/>
								  </c:when>
								  <c:otherwise>
								    0
								  </c:otherwise>
								...
								<h5 class="description-header" style="font-size:40px">
								<a href="detalleNoEncontradoWms?dateInicio=<%=starttime%>&estado=0" style="color: #333" alt="WMS Detalle" title="WMS Detalle">
								<c:choose>
								  <c:when test="${cantSoporteVentaWmsDif > 0}">
								    <fmt:formatNumber pattern="#,###,#00" value="${cantSoporteVentaWmsDif}"  type="number"/>
								  </c:when>
								...
								<!--  
								<c:choose>
								  <c:when test="${cantSoporteVentaWms > 0}">
								    <fmt:formatNumber pattern="#,###,#00" value="${cantSoporteVentaWms}"  type="number"/>
								  </c:when>
								  <c:otherwise>
								    0
								  </c:otherwise>
								...
								<span class="description-text" style="font-size:20px">WMS</span>
							  </div>
							  <!-- /.description-block -->
							</div>
							<!-- /.col -->
							<div class="col-sm-3 col-xs-6">
							  <div class="description-block">
							  	<a href="detalleNoEncontradoJda?dateInicio=<%=starttime%>&estado=0" alt="JDA Detalle" title="JDA Detalle">
								<span class="description-percentage text-yellow"><i class="fa fa-caret-right"></i> 
								<!--  
								-
								<c:choose>
								  <c:when test="${cantSoporteVentaJdaDif > 0}">
								    <fmt:formatNumber pattern="#,###,#00" value="${cantSoporteVentaJdaDif}"  type="number"/>
								  </c:when>
								  <c:otherwise>
								    0
								  </c:otherwise>
								...
								<h5 class="description-header" style="font-size:40px">
								<a href="detalleNoEncontradoJda?dateInicio=<%=starttime%>&estado=0" style="color: #333">
								<!--  
								<c:choose>
								  <c:when test="${cantSoporteVentaJda > 0}">
								    <fmt:formatNumber pattern="#,###,#00" value="${cantSoporteVentaJda}"  type="number"/>
								  </c:when>
								  <c:otherwise>
								    0
								  </c:otherwise>
								...
								<span class="description-text" style="font-size:20px">JDA</span>
							  </div>
							  <!-- /.description-block -->
							</div>
					  	</div>
