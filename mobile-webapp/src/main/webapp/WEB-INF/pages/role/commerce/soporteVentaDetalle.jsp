				...
				<div class="col-md-12">
				  <div class="box">
					<div class="box-header with-border">
					  <h3 class="box-title">Soporte Venta Detalle</h3>
						...
						<div class="row">
							<div class="col-sm-16 col-xs-6">
							  <div class="description-block border-right">
								...
								<c:choose>
								  <c:when test="${cantSoporteVentaPosJhonson > 0}">
								    <fmt:formatNumber pattern="#,###,#00" value="${cantSoporteVentaPosJhonson}"  type="number"/>
								  </c:when>
								  <c:otherwise>
								    0
								  </c:otherwise>
								...
								<span class="description-text" style="font-size:20px">POS Johnson</span>
							  </div>
							  <!-- /.description-block -->
							</div>
							<!-- /.col -->
							<div class="col-sm-3 col-xs-6">
							  <div class="description-block">
								...
								<h5 class="description-header" style="font-size:40px">
								<c:choose>
								  <c:when test="${cantSoporteVentaPosParis > 0}">
								    <fmt:formatNumber pattern="#,###,#00" value="${cantSoporteVentaPosParis}"  type="number"/>
								  </c:when>
								  <c:otherwise>
								    0
								  </c:otherwise>
								...
								<span class="description-text" style="font-size:20px">POS Paris</span>
							  </div>
							  <!-- /.description-block -->
							</div>
					  	</div>
						...
						<div class="row">
							<div class="col-sm-12 col-xs-12">
							  <div class="description-block">
								...
								<h5 class="description-header" style="font-size:40px">
								<c:choose>
								  <c:when test="${cantSoporteVentaPosParisCl > 0}">
								    <fmt:formatNumber pattern="#,###,#00" value="${cantSoporteVentaPosParisCl}"  type="number"/>
								  </c:when>
								  <c:otherwise>
								    0
								  </c:otherwise>
								...
								<span class="description-text" style="font-size:20px">Paris.cl</span>
							  </div>
							  <!-- /.description-block -->
							</div>
					  	</div>
					  	...
					  	<div class="row">
							<div class="col-sm-12 col-xs-12">
							  <div class="description-block">
								...
								<h5 class="description-header" style="font-size:40px">
								<c:choose>
								  <c:when test="${cantEcommerce > 0}">
								    <fmt:formatNumber pattern="#,###,#00" value="${  cantEcommerce + ( dif -  (cantEcommerce - cantSoporteVentaPosParisCl) ) }"  type="number"/>
								  </c:when>
								  <c:otherwise>
								    0
								  </c:otherwise>
								...
								<span class="description-text" style="font-size:20px">eCommerce</span>
							  </div>
							  <!-- /.description-block -->
							</div>
					  	</div>
					  	...
					  	<div class="row">
							<div class="col-sm-12 col-xs-12">
							  <div class="description-block">
							  	<a href="detalleNoEncontradoSoporteVenta?dateInicio=<%=starttime%>&estado=0">
								...
								<!--  -->
								<h5 class="description-header" style="font-size:20px">
								</h5>
								<span class="description-text">Diferencias Ecommerce Vs Soporte de Ventas</span>
							  </div>
							  <!-- /.description-block -->
							</div>
					  	</div>
