  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Reporte Cuadratura Venta en Verde PD Desde <span class="label label-primary" style=" background-color:#5bc0de"><i class="icon-time"></i> Desde ${starttime} Hasta ${endtime}</span><span class="divider"></span></li>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Reporte Cuadratura Venta en Verde PD</h3>
				<!-- 
              <div class="box-tools">
