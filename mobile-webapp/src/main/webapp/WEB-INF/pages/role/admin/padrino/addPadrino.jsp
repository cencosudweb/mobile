...
<html>
  <head>
    ...
    <script src="<c:url value="/js/admin/padrino/padrino.add.js"/>" type="text/javascript"></script>
  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            <h1 class="page-title">Nuevo Padrino</h1>
        </div>

		<ul class="breadcrumb">
			<li><a href="home">Home</a> <span class="divider">/</span></li>
			<li><a href="allPadrinos">Padrinos</a> <span class="divider">/</span></li>
				...
				<div class="well">
				    ...
				    <div id="myTabContent" class="tab-content">
				      ...
				      <jsp:include page="../../../include/messages.jsp" />
					    ...
					    <form:form method="post"  action="savePadrino" modelAttribute="newPadrino" id="f_add_padrino">
