...
<html>
  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            <h1 class="page-title">Nuevo Convenio para ${financial.businessLine}</h1>
        </div>
				...
				<div class="well">
				    ...
				    <div id="myTabContent" class="tab-content">
				      <div class="tab-pane active in" id="home">
					    ...
					    <form:form method="post"  action="saveAddAgreement" modelAttribute="newAgreement" id="f_add_agreement">
					        <form:label path="agreementId">* C&oacute;digo Convenio</form:label>
					        <form:input path="agreementId" cssClass="input-xlarge" maxlength="6"/>
					        </br><form:errors path="agreementId" cssStyle="color:red"></form:errors></br>
					     	
					        <form:label path="initDateText">* Fecha Inicio</form:label>
					        <form:input path="initDateText" readonly="true" id="dateInicio" cssClass="input-xlarge" />
					        </br><form:errors path="initDateText" cssStyle="color:red"></form:errors></br>
					     	
					     	<form:label path="endDateText">* Fecha Fin</form:label>
					        <form:input path="endDateText" readonly="true" id="dateFin" cssClass="input-xlarge" />
					        ...
					        <form:select path="timeLimit.id" items="${plazos}" itemValue="id" itemLabel="description"/></br>
					     	...
					     	</br><form:label path="" >(*) Todos los campos son requeridos</form:label></br>
					     	
					     	<fieldset>
							<legend>** Urls Comercio</legend>
								<table>
									<!-- url1 -->
									<tr>
									...
									<tr>
										<td colspan="3"><form:errors path="urls[0].confirmationPath" cssStyle="color:red"></form:errors></td>
										<td></td>
										<td></td>
									</tr>
									...
									<tr>
										<td colspan="3"><form:errors path="urls[1].confirmationPath" cssStyle="color:red"></form:errors></td>
										<td></td>
										<td></td>
									</tr>
									...
									<tr>
										<td colspan="3"><form:errors path="urls[2].confirmationPath" cssStyle="color:red"></form:errors></td>
										<td></td>
										<td></td>
									</tr>
								</table>
							...
							<form:label path="" >(**) Ingresar al menos una configuraci&oacute;n</form:label>
