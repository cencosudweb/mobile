...
<html>
  <head>
    ...
    <script src="<c:url value="/js/admin/gerente/gerente.all.js"/>" type="text/javascript"></script>
        ...
        <div class="container-fluid">
	        <div class="row-fluid">
				<div class="btn-toolbar">
				    <button id="btn-add-gerente" class="btn btn-primary"><i class="icon-plus"></i> Nuevo</button>
				    <!--
				...
				<div class="well">
					  ...
					  <c:if test="${!empty gerentes}">
					      <c:forEach items="${gerentes}" var="gerente" varStatus="status">
					            <tr>
						          ...
						          <td nowrap="nowrap">${gerente.description}</td>
						          <td nowrap="nowrap">${gerente.padrino.description}</td>
						          <td>
						          	  <!--  <a href="resetPassword1?id=${user.id}" title="Restablecer Clave" ><i class="icon-signin"></i> Restablecer Pass</a><br />-->
						              <a href="editGerente?id=${gerente.id}" title="Editar" ><i class="icon-pencil"></i>Editar</a><br />
						              <a href="#myModal" class="lockUnlock" modo='U' idgerente="${gerente.id}" title="Deshabilitar" role="button" data-toggle="modal" style="margin-right: 15px"><i class="icon-remove"></i>Eliminar</a><br />
						          </td>
						        </tr>
						</c:forEach>
				      </c:if>
					...
					<form method="post"  action="lockUnlockGerente" id="f_lock">
		        			<input type="hidden" name="id" id="id_gerente"/>
                            ...
                            rows: [
                                ...
                                return {
                                    ...
                                    cells: [
                                        ...
                                        { type: String, value: item.Padrino }
