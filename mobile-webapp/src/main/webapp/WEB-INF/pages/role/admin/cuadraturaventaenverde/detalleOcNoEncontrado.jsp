        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Detalle Venta En Verde - OC No Encontrado en JDA</h3>
				<!-- 
              <div class="box-tools">
					  	...
					  	<div class="row">
							<div class="col-sm-12 col-xs-12">
							  <div class="description-block">
								...
								<span class="description-text" style="font-size:20px">Cantidad No Encontrado en JDA</span>
							  </div>
							  <!-- /.description-block -->
							</div>
					  	</div>
