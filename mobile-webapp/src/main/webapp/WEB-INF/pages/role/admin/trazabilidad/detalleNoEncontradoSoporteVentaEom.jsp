        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Diferencias Soporte de Ventas / EOM</h3>
				<!-- 
              <div class="box-tools">
					  	...
					  	<div class="row">
							<div class="col-sm-12 col-xs-12">
							  <div class="description-block">
								...
								<span class="description-text" style="font-size:20px">Diferencias</span>
							  </div>
							  <!-- /.description-block -->
							</div>
					  	</div>
		...
		<div class="col-sm-12 col-xs-12">
			<div class="description-block">
				<h5 class="description-header" style="font-size:30px">
					<form role="form" id="f_all_user" method="get" action="eom">
