...
<html>
  <head>
    ...
    <script src="<c:url value="/js/admin/gerente/gerente.edit.js"/>" type="text/javascript"></script>
  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            <h1 class="page-title">Modificar Gerentes</h1>
        </div>

		<ul class="breadcrumb">
			<li><a href="home">Home</a> <span class="divider">/</span></li>
			<li><a href="allGerentes">Gerentes</a> <span class="divider">/</span></li>
				...
				<div class="well">
				    ...
				    <div id="myTabContent" class="tab-content">
				      <div class="tab-pane active in" id="home">
					    <form:form method="post"  action="saveEditGerente" modelAttribute="editGerente" id="f_edit_gerente">
					    	<form:hidden path="id" />
