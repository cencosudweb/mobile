...
<html>
  <head>
    ...
    <script src="<c:url value="/js/admin/financial/financial.add.js"/>" type="text/javascript"></script>
  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            <h1 class="page-title">Nueva Instituci&oacute;n Financiera</h1>
        </div>
				...
				<div class="well">
				    ...
				    <div id="myTabContent" class="tab-content">
				      <div class="tab-pane active in" id="home">
					    <form:form method="post"  action="saveFinancial" modelAttribute="newFinancial" id="f_add_financial">
					        ...
					        <form:label path="" >(*) Todos los campos son requeridos</form:label>
					    </form:form>
				      </div>
				  </div>
				</div>
