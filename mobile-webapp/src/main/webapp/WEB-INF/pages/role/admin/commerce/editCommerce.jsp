...
<html>
  <head>
    ...
    <script src="<c:url value="/js/admin/commerce/commerce.edit.js"/>" type="text/javascript"></script>
  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            <h1 class="page-title">Modificar Comercio</h1>
        </div>
            ...
            <div class="row-fluid">
				...
				<div class="well">
				    <ul class="nav nav-tabs">
				      <li class="active"><a href="#home" data-toggle="tab">Datos Comercio</a></li>
				    </ul>
				    <div id="myTabContent" class="tab-content">
				      <div class="tab-pane active in" id="home">
					    <form:form method="post"  action="saveEditCommerce" modelAttribute="editCommerce" id="f_edit_commerce">
					    	<form:hidden path="id" />
					        ...
					        <form:label path="economicAcivity">* Actividad Econ&oacute;mica</form:label>
