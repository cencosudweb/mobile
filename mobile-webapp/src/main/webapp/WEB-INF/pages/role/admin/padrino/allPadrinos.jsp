...
<html>
  <head>
    ...
    <script src="<c:url value="/js/admin/padrino/padrino.all.js"/>" type="text/javascript"></script>
  ...
  <!--<![endif]-->
    ...
    <div class="content">
        <div class="header">
            <h1 class="page-title">Padrinos</h1>
        </div>
        ...
        <div class="container-fluid">
	        <div class="row-fluid">
				<div class="btn-toolbar">
				    <button id="btn-add-padrino" class="btn btn-primary"><i class="icon-plus"></i> Nuevo</button>
				    <!--
				...
				<div class="well">
				    <table  id="example"  class="display" cellspacing="0" width="100%">
				      ...
				      <tbody>
					  <c:if test="${!empty padrinos}">
					      <c:forEach items="${padrinos}" var="padrino" varStatus="status">
					            <tr>
						          <td nowrap="nowrap">${status.count}</td>
						          <td nowrap="nowrap">${padrino.description}</td>
						          <td nowrap="nowrap">${padrino.tienda.description}</td>
						          <td>
						          	  <!--  <a href="resetPassword1?id=${user.id}" title="Restablecer Clave" ><i class="icon-signin"></i> Restablecer Pass</a><br />-->
						              <a href="editPadrino?id=${padrino.id}" title="Editar" ><i class="icon-pencil"></i>Editar</a><br />
						              <a href="#myModal" class="lockUnlock" modo='U' idpadrino="${padrino.id}" title="Deshabilitar" role="button" data-toggle="modal" style="margin-right: 15px"><i class="icon-remove"></i>Eliminar</a><br />
						          </td>
						        </tr>
						</c:forEach>
				      </c:if>
					...
					<form method="post"  action="lockUnlockPadrino" id="f_lock">
		        			<input type="hidden" name="id" id="id_padrino"/>
