        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Diferencias Soporte de Ventas </h3>
				<!-- 
              <div class="box-tools">
					  	...
					  	<div class="row">
							<div class="col-sm-12 col-xs-12">
							  <div class="description-block">
								...
								<c:choose>
								  <c:when test="${cantSoporteVentaNoEncontrados > 0}">
								    <fmt:formatNumber pattern="#,###,#00" value="${cantSoporteVentaNoEncontrados}"  type="number"/>
								  </c:when>
								  <c:otherwise>
								    0
								  </c:otherwise>
								...
								<h5 class="description-header" style="font-size:20px"></h5>
								<span class="description-text">Diferencias</span>
							  </div>
							  <!-- /.description-block -->
							</div>
					  	</div>
            ...
            <div class="box-body table-responsive no-padding">
                ...
                <c:forEach items="${detalles}" var="detalle" varStatus="status">
						<tr>
							<td>${status.count}</td>
						    <td>${detalle.numOrden}</td>
						    <td>
						    ${detalle.fecTranTsql}${detalle.numCtlTsl}${detalle.numTerTsl}${detalle.numTraTsql}
						    </td>
						 </tr>
					</c:forEach>
			 	</tbody>
		...
		<div class="col-sm-12 col-xs-12">
			<div class="description-block">
				<h5 class="description-header" style="font-size:30px">
					<form role="form" id="f_all_user" method="get" action="soporteVentaDetalle">
							<input type="hidden" name="dateInicio"  value="<%=request.getParameter("dateInicio") %>" />
