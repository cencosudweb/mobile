...
<html>
  <head>
    ...
    <script src="<c:url value="/js/profile/edit.js"/>" type="text/javascript"></script>
  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            <h1 class="page-title">Datos de la Cuenta</h1>
        </div>
            ...
            <div class="row-fluid">
				...
				<div class="well">
				    <ul class="nav nav-tabs">
				      <li class="active"><a href="#home" data-toggle="tab">Mis Datos</a></li>
				    </ul>
				    <div id="myTabContent" class="tab-content">
				      <div class="tab-pane active in" id="home">
					    ...
					    <form:form method="post"  action="saveEditProfile" modelAttribute="newUser" id="f_edit_user">
					    	<form:hidden path="id" />
					        ...
					        <form:label path="name">* Raz&oacute;n Social</form:label>
					        ...
					        <form:input path="email2" cssClass="input-xlarge" />
