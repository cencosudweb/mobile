...
/**
 * 
 *  @description Clase CuadraturaVtavPdDTO
 *
 */

public class CuadraturaVtavPdDTO implements Serializable {
	...
	public CuadraturaVtavPdDTO(){}
	
	public CuadraturaVtavPdDTO(Long id){
		this.id = id;
	}
