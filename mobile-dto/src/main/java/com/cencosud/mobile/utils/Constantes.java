...
public class Constantes {
	...
	public static final String APLICACION_NOMBRE = "MIDDLEWARE INVERSIONES SECURITY";

	public static final String ASUNTO_CARGA_ARCHIVOS = "CARGA DE ARCHIVOS INVERSIS";
	...
	public static final String MENSAJE_ERROR = "NO HAY REGISTROS";
	
	public static final String MENSAJE_ERROR2 = "ERROR GENERAL";
	
	public static final String MENSAJE_NO_HAY_REGISTROS = "NO HAY REGISTROS";

	public static final String CODIGO_EXITO = "1";
	...
	public static final String CODIGO_ERROR2 = "-1";
	...
	public static final String DESCRIPCION_RESPUESTA_AUTH = "DESCRIPCION";
	...
	public final static String APPLICATION_XML_ENCODE = "application/xml; charset=UTF-8";
