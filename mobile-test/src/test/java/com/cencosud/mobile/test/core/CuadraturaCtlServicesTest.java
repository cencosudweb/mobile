...
public class CuadraturaCtlServicesTest {
	...
	public void getCuadraturaCtlTest() {
		...
		int tranNbr = 0;
		int bogeda = 0;
		List<CuadraturaCtlDTO> counts = cuadraturaCtlServicesImpl.getCuadraturaCtls(carga, bogeda, starttime+" 00:00:00", endtime+" 23:59:59", tipo, tranNbr, estado, start, limit);
	...
	public void getEcommerceSoporteVentaCountTest() {
		...
		int tranNbr = 0;
		int bogeda = 0;
		int counts = cuadraturaCtlServicesImpl.getCuadraturaCtls(carga, bogeda, starttime+" 00:00:00", endtime+" 23:59:59", tipo, tranNbr, estado);
		assertNotNull("Listado de counts es null", counts);
